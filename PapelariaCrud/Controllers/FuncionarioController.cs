...
namespace PapelariaCrud.Controllers
{
    public class FuncionarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdFuncionario,Nome,CPF,Cargo,Telefone")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdFuncionario,Nome,CPF,Cargo,Telefone")] Funcionario funcionario)
        {
