...
namespace PapelariaCrud.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdFornecedor,Nome,CNPJ,Telefone,Email")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdFornecedor,Nome,CNPJ,Telefone,Email")] Fornecedor fornecedor)
        {
